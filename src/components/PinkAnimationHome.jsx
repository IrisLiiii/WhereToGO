...
export default function PinkAnimationHome({ goTo, goToCity, isCityMode = false, isMobile = false }) {
    ...
    const DEFAULT_LOG = '· 2026.3.5 你这样说：“想要你给我写一些信，关于我们一起去过的地方，经历过的事儿”，\n我说：“（我）情感没那么鲜活 会轻松 但也可能错过一些值得体验的东西 但我会慢慢写”。\n那前后你在经历很辛苦很辛苦的一段时期，我也从那时候一下子忙起来了。\n 4、5月在忙碌中度过，很充实，但没有探索的时间，好像被迫忘记了自由。\n 期间一直想尝试做点好玩的，也一直在想准备什么礼物好。\n 5月看到这个项目，当时就觉得很适合我们。 \n· 5.18 从最最基础的概念开始了解。 \n· 5.20 现在是零点，昨天在工位跑通了我们的页面😌，今天我们又要多一个First啦！\n';
