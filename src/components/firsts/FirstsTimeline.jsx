                ...
                <>
                    ...
                    <div className="layout-3-cols">
                        ...
                        <div className="firsts-gallery" ref={galleryScrollRef}>
                            <h3 className="gallery-title">Ours</h3>
                            <div className="gallery-masonry">
                                {allImages.length === 0 ? (
                                    <div className="gallery-empty">想记些什么，上传试试吧</div>
                                ) : (
                                    <>
                    ...
                    >
                        ...
                        >
                            <div className="firsts-modal-header">
                                <h2>{editingId ? '编辑Firsts' : '记录新的Firsts'} ✨</h2>
